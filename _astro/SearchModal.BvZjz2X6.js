...
<\/script>
`},{group:"blog",slug:"blog/why-and-how-I-moved-my-blog-from-middleman-ssg-to-astro-js",frontmatter:{title:"Why and How I Moved My Blog from Middleman SSG to Astro",date:"2024-12-29T18:20:00.000Z",tags:["GitHub","Astro"],image:"/images/middleman-to-astro.webp",author:"Lautaro Lobo"},content:`
¡Long time no see!
...
<\/script>`}];function R(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let A=R();function ne(h){A=h}const te=/[&<>"']/,ue=new RegExp(te.source,"g"),ae=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,pe=new RegExp(ae.source,"g"),ge={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},V=h=>ge[h];function v(h,t){if(t){if(te.test(h))return h.replace(ue,V)}else if(ae.test(h))return h.replace(pe,V);return h}const me=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function ye(h){return h.replace(me,(t,e)=>(e=e.toLowerCase(),e==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):""))}const fe=/(^|[^\[])\^/g;function f(h,t){let e=typeof h=="string"?h:h.source;t=t||"";const n={replace:(r,o)=>{let a=typeof o=="string"?o:o.source;return a=a.replace(fe,"$1"),e=e.replace(r,a),n},getRegex:()=>new RegExp(e,t)};return n}function K(h){try{h=encodeURI(h).replace(/%25/g,"%")}catch{return null}return h}const T={exec:()=>null};function Q(h,t){const e=h.replace(/\|/g,(o,a,s)=>{let i=!1,d=a;for(;--d>=0&&s[d]==="\\";)i=!i;return i?"|":" |"}),n=e.split(/ \|/);let r=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;r<n.length;r++)n[r]=n[r].trim().replace(/\\\|/g,"|");return n}function I(h,t,e){const n=h.length;if(n===0)return"";let r=0;for(;r<n;){const o=h.charAt(n-r-1);if(o===t&&!e)r++;else if(o!==t&&e)r++;else break}return h.slice(0,n-r)}function be(h,t){if(h.indexOf(t[1])===-1)return-1;let e=0;for(let n=0;n<h.length;n++)if(h[n]==="\\")n++;else if(h[n]===t[0])e++;else if(h[n]===t[1]&&(e--,e<0))return n;return-1}function X(h,t,e,n){const r=t.href,o=t.title?v(t.title):null,a=h[1].replace(/\\([\[\]])/g,"$1");if(h[0].charAt(0)!=="!"){n.state.inLink=!0;const s={type:"link",raw:e,href:r,title:o,text:a,tokens:n.inlineTokens(a)};return n.state.inLink=!1,s}return{type:"image",raw:e,href:r,title:o,text:v(a)}}function we(h,t){const e=h.match(/^(\s+)(?:```)/);if(e===null)return t;const n=e[1];return t.split(`
...
`)}}}fences(t){const e=this.rules.block.fences.exec(t);if(e){const n=e[0],r=we(n,e[3]||"");return{type:"code",raw:n,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:r}}}heading(t){const e=this.rules.block.heading.exec(t);if(e){let n=e[2].trim();if(/#$/.test(n)){const r=I(n,"#");(this.options.pedantic||!r||/ $/.test(r))&&(n=r.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:n,tokens:this.lexer.inline(n)}}}hr(t){const e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:e[0]}}blockquote(t){const e=this.rules.block.blockquote.exec(t);if(e){let n=e[0].replace(/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,`
    $1`);n=I(n.replace(/^ *>[ \t]?/gm,""),`
