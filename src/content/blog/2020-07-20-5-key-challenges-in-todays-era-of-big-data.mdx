...
<div class="guest-post">
  This{" "}
  <a href="https://www.makeen.io/5-key-challenges-in-todays-era-of-big-data/">
    article
  </a>{" "}
  is a a guest post by{" "}
  <a href="https://www.makeen.io/author/tamjid-aijazi/">Tamjid Aijazi</a> from{" "}
  <a href="https://www.makeen.io/">Makeen Technologies</a>
</div>
